...
spectrums = [s for s in load_from_mgf('save/casmi_2022_challenge_priority.mgf')]

sirius_path = "comparison/casmi2022_priority/SIRIUS"
...
deepmass_path = "D:/DeepMASS2_GUI/result/casmi2022_priority"
